...
export function CTASection({ locale }: { locale: Locale }) {
  const en = locale === "en";
  return (
    <section className="border-y border-flare bg-signal text-carbon">
      <div className="container-wide flex flex-col justify-between gap-8 py-14 md:flex-row md:items-center">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link href={`/${locale}/contact`} className="border border-carbon/40 px-5 py-3 text-sm font-bold transition hover:bg-carbon hover:text-white">
